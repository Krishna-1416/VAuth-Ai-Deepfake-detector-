          ...
          <div className="bg-white rounded-[2.5rem] border border-slate-200/60 shadow-sm overflow-hidden p-8">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 opacity-40">
                ...
                <p className="text-xs font-black uppercase tracking-widest italic">Syncing control center...</p>
              </div>
                ...
                {recentScans.map((scan) => (
                  <div key={scan.id} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-transparent hover:border-slate-200 transition-all group">
                    ...
                    <div className="text-right">
                      <p className={`text-xs font-black italic tracking-tighter uppercase mb-0.5 ${scan.result === 'Authentic' ? 'text-slate-950' : 'text-rose-600'}`}>{scan.result}</p>
              ...
              <div className="flex flex-col items-center justify-center py-20 bg-slate-50 rounded-3xl border border-slate-100 italic">
